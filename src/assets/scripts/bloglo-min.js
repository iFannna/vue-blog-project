...
var blogloGetIndex = function (e) {
    ...
    , blogloScrollTo = function () {
        ...
        function l() {
            ...
            this.options = o(e, n),
                this.easeFunctions = o({
                    easeOutQuart: t
                }, l)
        }

        return l.prototype.registerTrigger = function (e, t) {
            var n = this;
            if (e) {
                var l = e.getAttribute("href") || e.getAttribute("data-target")
                    , i = l && "#" !== l ? document.getElementById(l.substring(1)) : document.body
                    , r = o(this.options, function (e, t) {
                    var o = {};
                    return Object.keys(t).forEach((function (t) {
                            var n = e.getAttribute("data-mt-".concat(t.replace(/([A-Z])/g, (function (e) {
            ...
            l.prototype.move = function (e) {
                ...
                if (0 === e || e) {
                    l = o(this.options, l);
                    var i, r = "number" == typeof e ? e : e.getBoundingClientRect().top, s = n(l.container), c = null;
                    r -= l.tolerance;
                    window.requestAnimationFrame((function o(a) {
                            var d = n(t.options.container);
                            c || (c = a - 1);
                            var u = a - c;
                            if (i && (0 < r && i > d || 0 > r && i < d))
                                return l.callback(e);
                            i = d;
                            var m = t.easeFunctions[l.easing](u, s, r, l.duration);
                            l.container.scroll(0, m),
                                u < l.duration ? window.requestAnimationFrame(o) : (l.container.scroll(0, r + s),
                                    l.callback(e))
                        }
                    ))
                }
    ...
    , blogloGetParents = (e, t) => {
        ...
        for (var o = []; e && e !== document; e = e.parentNode)
            t ? e.matches(t) && o.push(e) : o.push(e);
        return o
    }
;
!function () {
...
var blogloTriggerEvent = function (e, t) {
    var o = new CustomEvent(t, 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {});
    e.dispatchEvent(o)
};
!function () {
    var t = document.getElementById("page")
        , o = () => {
            ...
            document.body.classList.contains("bloglo-is-mobile") || (o = window.innerWidth,
                document.querySelectorAll(".sub-menu").forEach((n => {
                        ...
                        t = l.left + window.pageXOffset,
                            e = t + l.width,
                            n.removeAttribute("style"),
                            e > o ? n.closest("li").classList.add("opens-left") : 0 > t && n.closest("li").classList.add("opens-right")
                    }
                )))
        }
        , n = e => {
        ...
        , i = () => {
            if (bloglo_vars["sticky-header"].enabled) {
                ...
                if ((document.body.classList.contains("bloglo-header-layout-3") || document.body.classList.contains("bloglo-header-layout-4")) && (e = document.querySelector("#bloglo-header .bloglo-nav-container"),
                    t = document.querySelector("#bloglo-header .bloglo-nav-container .bloglo-container")),
                window.outerWidth <= bloglo_vars["responsive-breakpoint"])
                    e = document.getElementById("bloglo-header"),
                        t = document.getElementById("bloglo-header-inner");
                if (null !== e && null !== t) {
                    var l, i, r = e.getBoundingClientRect().bottom, s = 0 >= r - l;
                    l = null === o || 600 >= window.outerWidth ? 0 : o.getBoundingClientRect().height;
                    var c = function () {
                        l = null === o || 600 >= window.outerWidth ? 0 : o.getBoundingClientRect().height,
                        ...
                        o.includes("mobile") && 481 > window.innerWidth && (s = !1),
                            s ? document.body.classList.contains("bloglo-sticky-header") || ((i = document.createElement("div")).setAttribute("id", "bloglo-sticky-placeholder"),
                                i.style.height = t.getBoundingClientRect().height + "px",
                                e.appendChild(i),
                                document.body.classList.add("bloglo-sticky-header"),
                                document.body.style.setProperty("--bloglo-sticky-h-offset", e.offsetHeight + 20 + "px")) : (document.body.classList.contains("bloglo-sticky-header") && (document.body.classList.remove("bloglo-sticky-header"),
                    ...
                    "true" !== e.getAttribute("data-resize-listener") && (window.addEventListener("resize", (function () {
                            n(c())
                        }
                    )),
    ...
    function r() {
        for (var e = this; !e.classList.contains("bloglo-nav");)
            "li" === e.tagName.toLowerCase() && (e.classList.contains("hovered") ? e.classList.remove("hovered") : e.classList.add("hovered")),
                e = e.parentElement
    }
    ...
    var s = () => {
        ...
        , c = (e = 0) => {
            if (null !== document.getElementById("bloglo-preloader")) {
                var t = () => {
                        document.body.classList.contains("bloglo-loaded") || (document.body.classList.add("bloglo-loading"),
                            setTimeout((function () {
                ...
                ;
                return 0 < e ? setTimeout((function () {
                        t()
                    }
                ), e) : t(),
                    !1
        ...
        , a = () => {
            window.innerWidth <= bloglo_vars["responsive-breakpoint"] ? document.body.classList.add("bloglo-is-mobile") : document.body.classList.contains("bloglo-is-mobile") && (document.body.classList.remove("bloglo-is-mobile"),
    ...
    document.addEventListener("DOMContentLoaded", (function () {
            var e, n;
            c(5e3),
            document.body.classList.contains("bloglo-menu-accessibility") && document.querySelectorAll(".bloglo-nav").forEach((e => {
                        ...
                        if (document.body.classList.contains("bloglo-has-comments-toggle") && null != document.getElementById("bloglo-comments-toggle")) {
                            var e = e => {
                                    void 0 !== e && e.preventDefault(),
                                        document.body.classList.contains("comments-visible") ? (document.body.classList.remove("comments-visible"),
                                            document.getElementById("bloglo-comments-toggle").querySelector("span").innerHTML = bloglo_vars.strings.comments_toggle_show) : (document.body.classList.add("comments-visible"),
                                            document.getElementById("bloglo-comments-toggle").querySelector("span").innerHTML = bloglo_vars.strings.comments_toggle_hide)
                                }
                            ;
                        ...
                        if (0 !== e.length) {
                            e.forEach((e => {
                                    e.addEventListener("click", (t => {
                                            t.preventDefault(),
                                                e.classList.contains("bloglo-active") ? n(e) : o(e)
                                        }
                                    ))
                                }
                            )),
                                document.querySelectorAll(".bloglo-search-close").forEach((e => e.addEventListener("click", (function (t) {
                                        t.preventDefault(),
                                        e.classList.contains("bloglo-active") || (n(document.querySelector(".bloglo-search")),
                            ...
                            var o = function (e) {
                                document.querySelectorAll(".bloglo-search-form").forEach((function (e) {
                                        ...
                                        document.addEventListener("keydown", (function (t) {
                                                ...
                                                l = (n = e.querySelectorAll("input, a, button"))[n.length - 1],
                                                    o = n[0],
                                                    i = 9 === t.keyCode,
                                                !(r = t.shiftKey) && i && l === document.activeElement && (t.preventDefault(),
                                                    o.focus()),
                                                r && i && o === document.activeElement && (t.preventDefault(),
                                                    l.focus())
                                            }
                                        ))
                                    }
                                    ...
                                    setTimeout((function () {
                                            ...
                                            null !== e.nextElementSibling && null !== e.nextElementSibling.querySelector("input") && (e.nextElementSibling.querySelector("input").focus(),
                                                e.nextElementSibling.querySelector("input").select())
                                        }
                                    ), 100),
                                ...
                                document.body.classList.remove("bloglo-search-visible"),
                                    e.classList.remove("bloglo-active"),
                                    document.removeEventListener("keydown", l),
                                    t.removeEventListener("click", i)
                            }
                                , l = function (e) {
                                27 == e.keyCode && document.querySelectorAll(".bloglo-search").forEach((e => {
                                        n(e)
                                    }
                                ))
                            }
                                , i = function (e) {
                                null === e.target.closest(".bloglo-search-container") && null === e.target.closest(".bloglo-search") && document.querySelectorAll(".bloglo-search").forEach((e => {
                                        n(e)
                                    }
                                ))
                            }
                ...
                (() => {
                        ...
                        document.querySelectorAll(".bloglo-mobile-nav > button").forEach((e => {
                                e.addEventListener("click", (function (e) {
                                        e.preventDefault(),
                                            document.body.parentNode.classList.contains("is-mobile-menu-active") ? l() : n()
                                    }
                                ), !1)
                            }
                        )),
                            document.addEventListener("keydown", (function (e) {
                                    var t, o, n, l, i, r;
                                    o = document.querySelector(".bloglo-mobile-nav"),
                                        r = document.querySelector(".bloglo-hamburger-bloglo-primary-nav"),
                                        l = (n = o.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])'))[n.length - 1],
                                        t = r,
                                        e.keyCode,
                                        i = e.shiftKey;
                                    let s = "Tab" === e.key || 9 === e.keyCode;
                                    if (document.body.parentNode.classList.contains("is-mobile-menu-active")) {
                                        if (!s)
                                            return;
                                        i ? document.activeElement === t && (l.focus(),
                                            e.preventDefault()) : document.activeElement === l && (t.focus(),
                                            e.preventDefault())
                                    }
                                }
                            ));
                        var n = function (t) {
                                ...
                                document.body.classList.contains("bloglo-is-mobile") && n.forEach((function (e) {
                                        if (!e)
                                            return !1
                                    }
                                )),
                            ...
                            , l = function (t) {
                                ...
                                null !== e && e.removeEventListener("click", i),
                                    ...
                                    document.body.classList.contains("bloglo-is-mobile") ? (document.querySelectorAll("#bloglo-header .bloglo-nav").forEach((e => {
                                            e.removeEventListener("click", s)
                                        }
                                    )),
                                        blogloSlideUp(o, 250)) : o.style.display = null
                            }
                            , i = function (e) {
                            ...
                            , s = function (e) {
                                e.target.parentElement.querySelectorAll(".sub-menu").length && (e.preventDefault(),
                                "button" === e.target.type && c(e.target.parentElement))
                            }
                            , c = e => {
                                e.classList.contains("bloglo-open") ? (e.classList.remove("bloglo-open"),
                ...
                a(),
                o(),
            null !== (n = document.querySelector(".single .comments-link")) && n.addEventListener("click", (function (e) {
    ...
    const d = function () {
        ...
        let t, o, n, l, i, r, s, c, a;

        function d({target: t}) {
            if (e.classList.add("is-active"),
            t.getAttribute("data-cursor-label") && (App.body.classList.add("is-cursor-active"),
                e.classList.add("has-label"),
                o.innerHTML = t.getAttribute("data-cursor-label")),
                t.getAttribute("data-cursor-icon")) {
                App.body.classList.add("is-cursor-active"),
                    e.classList.add("has-icon");
                t.getAttribute("data-cursor-icon")
            }
        }
        ...
        function u({target: t}) {
            App.body.classList.remove("is-cursor-active"),
                ...
                e.classList.remove("has-label"),
                e.classList.remove("has-icon"),
                o.innerHTML = "",
                n.innerHTML = ""
        }

        function m() {
            e && (c = document.querySelectorAll(["button", "a", "input", "[data-cursor]", "[data-cursor-label]", "[data-cursor-icon]", "textarea"]),
                c.forEach((e => {
        ...
        return {
            init: function () {
                ...
                const c = () => {
                        e.style.transform = `translate(${l - r}px, ${i - s}px)`,
                ...
                requestAnimationFrame(c),
                    ...
                    function () {
                        ...
                        if (!App.config.cursorFollower.disableBreakpoint)
                            return;
                        (0 < window.innerWidth ? window.innerWidth : screen.width) < App.config.cursorFollower.disableBreakpoint ? (a = !1,
    ...
    if (document.body.classList.contains("is-parallax-footer")) {
        ...
        function m(e, t) {
            ...
            !function (e) {
                ...
                t.style.bottom = "0") : (t.style.bottom = "",
                t.style.top = "0"),
                window.scrollY > (o = e).offsetTop + o.offsetHeight ? (t.style.position = "static",
                    u.style.marginBottom = "0") : (u.style.marginBottom = t.offsetHeight + "px",
    ...
    var g, b;
    document.addEventListener("DOMContentLoaded", (function () {
            const e = document.querySelector('.bloglo-darkmode input[type="checkbox"]');
            if (e) {
                let o = bloglo_vars.dark_mode || "dark" === localStorage.getItem("darkmode");

                function t(t) {
                    t ? (document.documentElement.setAttribute("data-theme", "dark"),
                        localStorage.setItem("darkmode", "dark"),
                        e.classList.add("active")) : (document.documentElement.setAttribute("data-theme", "light"),
    ...
    function (e) {
        e(document).ready((function () {
                ...
                if (e("#bloglo-date").length) {
                    ...
                    document.getElementById("bloglo-date").innerHTML = e.toLocaleString(document.documentElement.lang, t)
                }
                let t = e(".ticker-slider-items")
                    , o = "left";
                if (e("body").hasClass("rtl") && (hrtl = !0,
                    o = "right"),
                    t.length) {
                    let n = t.find(".ticker-slider-wrap").marquee({
                        speed: 50,
                        duration: 14e3,
                        gap: 0,
                        delayBeforeStart: 0,
                    ...
                    t.on("click", ".ticker-slider-pause", (function () {
                            e(this).find("i").toggleClass("fa-pause fa-play"),
                                n.marquee("toggle")
                        }
                    ))
                }
                e(".masonries").length && setTimeout((() => {
                        e(".masonries").masonry({
